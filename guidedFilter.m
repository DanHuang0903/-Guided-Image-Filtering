%   This funciton is to implement guided filter by calling function
%   localMean(), variance(), and covariance().
%   It requires four parameters: input image, guidance image, filter 
%   window radius, and weight.
%   Author: Dan Huang
